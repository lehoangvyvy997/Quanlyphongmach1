...
{
    public partial class fr_duocphamdvytesocuu : Form
    {
        public fr_duocphamdvytesocuu()
        {
            InitializeComponent();
        }
        E_tb_Duocphamdvttesocuu thucthi = new E_tb_Duocphamdvttesocuu();
        ConnectDB cn = new ConnectDB();
        EC_tb_Duocphamdvytesocuu ck = new EC_tb_Duocphamdvytesocuu();
        ...
        public void khoitaoluoi()
        {
            ...
            dgv_ds1.Columns[1].HeaderText = "Mã dược phẩm ý tế";
            dgv_ds1.Columns[1].Width = 150;
            dgv_ds1.Columns[2].HeaderText = "Tên dược phẩm ý tế";
            ...
            dgv_ds1.Columns[8].HeaderText = "Giá bán";
            ...
            dgv_ds2.Columns[1].HeaderText = "Mã dược phẩm ý tế";
            dgv_ds2.Columns[1].Width = 150;
            dgv_ds2.Columns[2].HeaderText = "Tên dược phẩm ý tế";
            ...
            dgv_ds2.Columns[8].HeaderText = "Giá bán";
        ...
        public void hienthi()
        {
            string sql1 = "SELECT MaLoaiDuocPham, MaDuocPhamDVSoCuu, TenDuocPham, CongDung, DonVi, GiaNhap, NgayNhap, TinhTrangConSD, GiaBan, SoLuongCon FROM dbo.DUOCPHAMDVYTESOCUU where GiaBan != 'null'";
            dgv_ds1.DataSource = cn.taobang(sql1);

            string sql2 = "SELECT MaLoaiDuocPham, MaDuocPhamDVSoCuu, TenDuocPham, CongDung, DonVi, GiaNhap, NgayNhap, TinhTrangConSD, GiaBan, SoLuongCon FROM dbo.DUOCPHAMDVYTESOCUU where GiaBan = 'null'";
        ...
        {
            string sql1 = "SELECT MaLoaiDuocPham, MaDuocPhamDVSoCuu, TenDuocPham, CongDung, DonVi, GiaNhap, NgayNhap, TinhTrangConSD, GiaBan, SoLuongCon FROM dbo.DUOCPHAMDVYTESOCUU where MaDuocPhamDVSoCuu = '" + key + "'";
            dgv_ds1.DataSource = cn.taobang(sql1);
            SqlConnection con = cn.getcon();
            con.Open();
            try
        ...
        {
            string sql2 = "SELECT MaLoaiDuocPham, MaDuocPhamDVSoCuu, TenDuocPham, CongDung, DonVi, GiaNhap, NgayNhap, TinhTrangConSD, GiaBan, SoLuongCon FROM dbo.DUOCPHAMDVYTESOCUU  where MaDuocPhamDVSoCuu = '" + key + "'";
            dgv_ds2.DataSource = cn.taobang(sql2);
            SqlConnection con = cn.getcon();
            con.Open();
            try
        ...
        private void fr_duocphamdvytesocuu_Load(object sender, EventArgs e)
        {
            thucthi.load_maduocphamyte(txt_search1);
            thucthi.load_maduocphamyte(txt_search2);
            locktext();
            hienthi();
            khoitaoluoi();
        }
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            switch (key)
            {
                ...
                case 3:
                    {
                        MessageBox.Show("Giá bán không được để trống", "Chú Ý", MessageBoxButtons.OK);
                        txt_giaban.Focus();
                        break;
                    }
                default:
        ...
        private void dgv_ds1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(dong!=-1)
            {
                ...
                txt_madpdv.Text = dgv_ds1.Rows[dong].Cells[1].Value.ToString();
                txt_tendpdv.Text = dgv_ds1.Rows[dong].Cells[2].Value.ToString();
        ...
        private void dgv_ds2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_tenloaithuoc.Text = thucthi.load_tenldp(txt_tenloaithuoc.Text, txt_maloaithuoc.Text);
            txt_madpdv.Text = dgv_ds2.Rows[dong].Cells[1].Value.ToString();
            txt_tendpdv.Text = dgv_ds2.Rows[dong].Cells[2].Value.ToString();
